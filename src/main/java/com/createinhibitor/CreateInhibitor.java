...
public class CreateInhibitor {
    ...
    public static final DeferredHolder<CreativeModeTab, CreativeModeTab> CREATIVE_TAB = CREATIVE_TABS.register("main", () -> 
        CreativeModeTab.builder()
            ...
            .displayItems((parameters, output) -> {
                // Populated automatically by Registrate defaultCreativeTab
            })
            .build()
    );
    
    public static final DeferredHolder<BlockEntityType<?>, BlockEntityType<RotationalInhibitorBlockEntity>> ROTATIONAL_INHIBITOR_BLOCK_ENTITY = 
    ...
    public CreateInhibitor(IEventBus modEventBus) {
